...
async def giveaway( ctx, seconds: int, *, text ):
    ...
    message = await ctx.send(embed = discord.Embed(
        ...
        text = '𝓓𝓮𝓐𝓭𝓜𝓪𝓝🥀#8992 © | Все права защищены',
...
async def botinfo(ctx):
    ...
    embed.add_field(name=f'**Меня создал:**', value="`𝓓𝓮𝓐𝓭𝓜𝓪𝓝🥀#8992`(<@668325441224048641>)", inline=False)  # Создает строку
    ...
    embed.set_footer(text=f"𝓓𝓮𝓐𝓭𝓜𝓪𝓝🥀#8992 © | Все права защищены", icon_url='https://cdn.discordapp.com/avatars/668325441224048641/35c209140cdefe1485466d33aa3a1ce1.webp?size=1024') # создаение футера
    await ctx.send(embed=embed)
