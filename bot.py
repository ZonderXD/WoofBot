...
async def giveaway( ctx, seconds: int, *, text ):
    ...
    message = await ctx.send(embed = discord.Embed(
        ...
        text = '𝙵𝚛𝚒𝚍ツ#9691 © | Все права защищены',
...
async def botinfo(ctx):
    ...
    embed.add_field(name=f'**Меня создал:**', value="`𝙵𝚛𝚒𝚍ツ#9691`(<@668325441224048641>)", inline=False)  # Создает строку
    ...
    embed.set_footer(text=f"𝙵𝚛𝚒𝚍ツ#9691 © | Все права защищены", icon_url='https://cdn.discordapp.com/avatars/668325441224048641/a_4e8ca44ab97caaac6dafaed8e6dd6ec3.gif?size=1024') # создаение футера
    await ctx.send(embed=embed)
